# duvide Developer Guidelines

This file provides guidelines for agentic coding assistants working on the du vide iOS app codebase.
...
### Running Tests
This project includes unit tests; run `make test`.
