...
class ThemeManager: ObservableObject {
  ...
  static let availableColors: [(name: String, color: Color)] = [
    ("Aura Cerulean", Color(hex: "#72B3DD")),
  ...
  private static let defaultColorName = "Aura Cerulean"

  @AppStorage(
    "foqosThemeColorName", store: UserDefaults(suiteName: "group.com.kingston.loqin"))
